...
In employee advocacy programs, Company Page content may be curated and reposted by employees, franchisees and other advocates. The resulting activity and conversations are not always surfaced through a single Company Page-centric notification workflow. Agency and client administrators therefore need a practical way to identify relevant activity associated with the Company Page and determine when attention may be required.
